...
from keras.layers import Dense, Flatten, Dropout, Activation, MaxPooling2D, ELU
...
hist = model.fit_generator(generator=imgH.get_training_batch(), samples_per_epoch=train_samples, nb_epoch=8,
